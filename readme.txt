...
1. From the WP admin panel, click gPluginsh -> gAdd newh.
2. In the browser input box, type gMy Custom Style Css Managerh.
3. Select the gMy Custom Style Css Managerh plugin and click gInstallh.
